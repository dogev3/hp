...
import BaseCard from "../../BaseCard"; // plasmic-import: 0GPIrbnVLZcAQ1/component
import Bullet from "../../Bullet"; // plasmic-import: iVcoQgkTcHIe5O/component
...
import * as sty from "./PlasmicPlan.module.css"; // plasmic-import: Zc5zsu0_pie2Wt/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.box__zx6Eo)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box___36Mjx)}
        >
          {p.renderPlasmicSlot({
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.box__buosm)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__qoElq)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__p9Yik)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__kgv84)}
                />
              </p.Stack>
            ),
          ...
          <div className={classNames(defaultcss.all, sty.box__dvXia)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <LinkButton
                  text={"Get started"}
