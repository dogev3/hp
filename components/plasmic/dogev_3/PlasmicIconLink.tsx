...
import * as sty from "./PlasmicIconLink.module.css"; // plasmic-import: VqjkFxSwk67zU/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(defaultcss.all, sty.svg__mbut)}
              role={"img"}
            />
          ),
