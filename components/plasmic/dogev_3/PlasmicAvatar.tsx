...
import * as sty from "./PlasmicAvatar.module.css"; // plasmic-import: s5IQ2d-8Gd0ebY/css
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <img
            alt={""}
            className={classNames(defaultcss.img, sty.img__zlpsX)}
            role={"img"}
