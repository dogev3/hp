...
import * as sty from "./PlasmicBaseCard.module.css"; // plasmic-import: 0GPIrbnVLZcAQ1/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.box__dWOi7, {
          [sty.box__long__dWOi7WIhNl]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box___7UeKo, {
            [sty.box__long___7UeKOwIhNl]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg__dE6Ah)}
                role={"img"}
              />
            ),
