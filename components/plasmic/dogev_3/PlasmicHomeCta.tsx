...
import * as sty from "./PlasmicHomeCta.module.css"; // plasmic-import: fKZXqJAVxWinh/css

import SphereIcon from "./icons/PlasmicIcon__Sphere"; // plasmic-import: uxVEIEbqX6_Ikt/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__dMkNb)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__lUpk9)}
        >
          <input
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? false : true) ? (
        <div className={classNames(defaultcss.all, sty.box__zhxH)}>
          <SphereIcon
