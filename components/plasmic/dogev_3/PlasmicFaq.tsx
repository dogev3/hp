...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: OU-3v4LCAeJkCN/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__lm3So)}
      >
        <div className={classNames(defaultcss.all, sty.box__dFd8)}>
          <div className={classNames(defaultcss.all, sty.box__ncSau)}>
            {p.renderPlasmicSlot({
