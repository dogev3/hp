...
export type UniswapUniLogosvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function UniswapUniLogosvgIcon(props: UniswapUniLogosvgIconProps) {
  const { className, style, title, ...restProps } = props;
  return (
    <svg
      xmlns={"http://www.w3.org/2000/svg"}
      data-bbox={"-0.004 0 168.349 193.9"}
...
export default UniswapUniLogosvgIcon;
/* prettier-ignore-end */
